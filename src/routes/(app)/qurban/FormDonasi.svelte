<script lang="ts">
	...
	const selectQurbanKambing = [
		{ value: 'A', label: 'Tipe A (27kg) - Rp.2,7jt' },
		{ value: 'B', label: 'Tipe B (30kg) - Rp.3jt' },
		{ value: 'C', label: 'Tipe C (35kg) - Rp.3,5jt' },
		{ value: 'D', label: 'Tipe D (37kg) - Rp.3,7jt' },
		{ value: 'E', label: 'Tipe E (40kg) - Rp.4jt' },
		{ value: 'F', label: 'Tipe F (45kg) - Rp.4,5jt' },
		{ value: 'G', label: 'Tipe G (50kg) - Rp.5jt' },
		{ value: 'H', label: 'Tipe H (60kg) - Rp.6jt' },
	...
	const selectRekening = [
		...
		{ value: 'BSI', label: 'BSI: 7026717803 (Yayasan Istiqomah)' }
	];
	...
	<div class="flex flex-col gap-5">
		...
		<div class="flex flex-col md:grid md:grid-cols-[40%_1fr] items-center gap-5">
			<div class="flex flex-col gap-2 w-full">
				<div
					class="w-full h-fit text-sm py-2 px-3 flex justify-center items-center bg-istq-green text-istq-black rounded-md"
				>
		...
		<button
			...
			class="bg-istq-orange text-istq
       py-3 px-auto rounded-xl hover:bg-istq-orange/90 focus:outline-none
